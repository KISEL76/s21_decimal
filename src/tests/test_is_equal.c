...
START_TEST(s21_is_equal_0) {
  ...
  ck_assert_int_eq(s21_is_equal(src1, src2), TRUE);
}
END_TEST
...
START_TEST(s21_is_equal_4) {
  // 10
  s21_decimal src1 = {{0xA, 0xFFFFFFFF, 0xFFFFFFFF, 0}};
  // 100
  s21_decimal src2 = {{0x64, 0xFFFFFFFF, 0xFFFFFFFF, 0}};
  ck_assert_int_eq(FALSE, s21_is_equal(src1, src2));
}
END_TEST
...
START_TEST(s21_is_equal_5) {
  s21_decimal src1 = {{0, 0, 0, 0}};
  s21_set_bit(&src1, 32, 1);
  s21_decimal src2 = {{0, 0, 0, 0}};
  s21_set_bit(&src2, 28, 1);
...
START_TEST(s21_is_equal_7) {
  // 256
  s21_decimal src1 = {{0x100, 0, 0, 0}};
  // 257
  s21_decimal src2 = {{0x101, 0, 0, 0}};
...
Suite *s21_test_is_equal(void) {
  Suite *s = suite_create("equal_test");
  TCase *tc = tcase_create("case_is_equal");

  tcase_add_test(tc, s21_is_equal_0);
